...
10. [x] 增加 `docs/metadata.json` 与无依赖治理脚本，校验文档覆盖、状态、标题、truth scope、替代链和相对链接；`docs/README.md` 改为自动生成，并把 `docs:check` 接入 `test:ci`。
