...
export class ClaudeCliRunner implements AgentRunner {
  ...
  constructor(options: ClaudeCliRunnerOptions = {}) {
    ...
    // Safe by default. Any permission bypass must be an explicit deployment decision.
    this.permissionMode = options.permissionMode ?? process.env.CLAUDE_RUNNER_PERMISSION_MODE ?? "default";
